...
public class BookDao {
	...
	public ArrayList<Book> weeklyBestAll(Connection conn) {
		// select문 => ResultSet객체 (한행) => book객체
		ArrayList<Book> list = new ArrayList<>();
		PreparedStatement pstmt = null;
		ResultSet rset = null;
		
		String sql = prop.getProperty("weeklyBestAll"); // 미완성된 sql문
	...
	public ArrayList<Book> weeklyBestNovel(Connection conn) {
		// select문 => ResultSet객체 (한행) => book객체
		ArrayList<Book> list = new ArrayList<>();
		PreparedStatement pstmt = null;
		ResultSet rset = null;
		
		String sql = prop.getProperty("weeklyBestNovel"); // 미완성된 sql문
	...
	public ArrayList<Book> weeklyBestPoem(Connection conn) {
		// select문 => ResultSet객체 (한행) => book객체
		ArrayList<Book> list = new ArrayList<>();
		PreparedStatement pstmt = null;
		ResultSet rset = null;
		
		String sql = prop.getProperty("weeklyBestPoem"); // 미완성된 sql문
