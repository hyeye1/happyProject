...
<link rel="stylesheet" href="css/hover-min.css">
    <style>
        ...
        form{margin-left: 3%; }
        label{margin-top: 50px; font-weight: bold;}
        textarea{margin-left: 16%;}
        ...
        <div id="content">
            ...
            <div id="sub_title">
                ...
                <form action="noticeEnroll">
                    ...
                    <input type="text" style="width: 500px;" name="noticeTitle" max="30" required>
                    <br>
                    ...
                    <br>
                    <label for="noticeCentent">* 공지내용</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <br>
                    <textarea name="noticeCentent" id="" cols="80" rows="8" required></textarea>

                    <br><br>
                    <button id="noticeEnroll" type="submit" class="btn btn-primary hvr-float" ><b>공지등록</b></button>
                    <button id="noticeReset" type="reset" class="btn btn-primary hvr-float"><b>뒤로가기</b></button>
                </form>
