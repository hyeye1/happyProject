        ...
        <div id="content">
            ...
            <div id="sub_title">
                ...
                <form action="noticeEnroll">
                    ...
                    <br><br>
                    <button id="editEnroll" type="submit" class="btn btn-primary hvr-float" ><b>수정하기</b></button>
                    <button id="editReset" type="reset" class="btn btn-primary hvr-float"><b>뒤로가기</b></button>
                </form>
